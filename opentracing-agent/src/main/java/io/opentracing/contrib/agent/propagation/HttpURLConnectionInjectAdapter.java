 ...
 */
package io.opentracing.contrib.agent.propagation;
...
/**
 * Inject adapter for use with {@link HttpURLConnection}.
 */
public final class HttpURLConnectionInjectAdapter implements TextMap {

    private final HttpURLConnection connection;

    public HttpURLConnectionInjectAdapter(Object connection) {
